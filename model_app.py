...
Original file is located at
    https://colab.research.google.com/drive/13Uh5weCXL5Dadvkzw0L3nn7g4zj6tzdL
"""
...
import pandas as pd # Import pandas as it's used to create X and y
from sklearn.model_selection import train_test_split # Import train_test_split as it's used for splitting data
...
# prompt: make train the naive bayes
...
cv_scores_gnb = cross_val_score(gnb_model, X, y, cv=StratifiedKFold(n_splits=5))
print("\nGaussian Naive Bayes Cross-validation scores (5-fold stratified):", cv_scores_gnb)
print("Mean cross-validation score:", np.mean(cv_scores_gnb))
